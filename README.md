ЭТО ПРИЛОЖЕНИЕ ПЕРЕПИСАНО С МОЕГО ПРОШЛОГО ПРОЕКТА https://github.com/sanisan1/Bank под требование техничего задания + мои доработки и идеи из прошлого проетк
